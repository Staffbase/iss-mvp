...
class App extends Component {
  ...
  sliceTags = async (input) =>{
    let position = input.search("family_name");
    let position2 = input.search("role");
    this.tags  = input.slice(position, position2);
  };
...
<Form>
  <Form.Group className="mvp-1" controlId="formBasicFirstName">
    ...
    <Form.Control type="text" value={this.firstname} placeholder={this.firstname} />
  </Form.Group>
  <br></br>
  <Form.Group className="mvp-1" controlId="formBasicLastName">
    <Form.Label>Last Name</Form.Label>
    <Form.Control type="text" value={this.lastname} placeholder={this.lastname} />
  </Form.Group>
  <br></br>
